...
namespace PowerSiteBuilder\Widgets;
	...
	class Power_Site_Builder_Author_Info extends \Elementor\Widget_Base {
		...
		protected function render() {
			...
			if($psb_author_info_use_custom_author == 'yes' ){
				...
				$avater = $psb_author_info_custom_avater['url'] != '' ?
					\Elementor\Group_Control_Image_Size::get_attachment_image_html( $settings, 'psb_author_info_custom_avater_size', 'psb_author_info_custom_avater' ) : '';
			}else{
				$name = get_the_author();
