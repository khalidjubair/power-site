...
namespace PowerSiteBuilder\Widgets;
	...
	class Power_Site_Builder_Post_Title extends \Elementor\Widget_Base {
		...
		public function get_title() {
			return __( 'Post Title', 'power-site-builder' );
		}
		...
		protected function _register_controls() {
			$this->start_controls_section(
				...
				[
					'label' => __( 'Post Title', 'power-site-builder' ),
				]
			);
			$this->add_control(
			...
			$this->add_control(
				...
				[
					...
					'default'     => __( 'Post Title', 'power-site-builder' ),
		...
		protected function render() {
			...
			echo '<'.$psb_post_title_tag.' class="power-post-title">
				'.\Power_Site_Builder\Libs\Helpers::kses($post_title).'
			</'.$psb_post_title_tag.'>';
