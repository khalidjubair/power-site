...
var Collapse = function ($$$1) {
  ...
  var Selector = {
    ...
    DATA_TOGGLE: '[data-power-toggle="collapse"]'
    /**
     * ------------------------------------------------------------------------
     * Class Definition
     * ------------------------------------------------------------------------
  ...
  function () {
    function Collapse(element, config) {
      ...
      this._triggerArray = $$$1.makeArray($$$1("[data-power-toggle=\"collapse\"][href=\"#" + element.id + "\"]," + ("[data-power-toggle=\"collapse\"][data-target=\"#" + element.id + "\"]")));
    ...
    _proto._getParent = function _getParent() {
      ...
      var selector = "[data-power-toggle=\"collapse\"][data-parent=\"" + this._config.parent + "\"]";
...
var Tab = function ($$$1) {
  ...
  var Selector = {
    ...
    ACTIVE: '.active',
    ACTIVE_UL: '> li > .active',
    DATA_TOGGLE: '[data-power-toggle="tab"], [data-power-toggle="pill"], [data-power-toggle="list"]',
